...
mongod --replSet shard1 --port 27022 --shardsvr --slave  --dbpath $SWMONGO/shard1/slave1 --pidfilepath $SWMONGO/pids/shard1-slash1.pid --logpath $SWMONGO/logs/shard1-slave1.log --logappend --source localhost:27021 &
mongod --replSet shard1 --port 27023 --shardsvr --slave  --dbpath $SWMONGO/shard1/slave2 --pidfilepath $SWMONGO/pids/shard1-slash2.pid --logpath $SWMONGO/logs/shard1-slave2.log --logappend --source localhost:27021 &
...
mongos --port 27017 --configdb localhost:27019 --chunkSize 1 --pidfilepath $SWMONGO/pids/router.pig --logpath $SWMONGO/logs/router.log --logappend &
